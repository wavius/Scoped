...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , clk_25m{vlSymsp->TOP.clk_25m}
    , ulpi_clk60{vlSymsp->TOP.ulpi_clk60}
    , ulpi_data{vlSymsp->TOP.ulpi_data}
    , ulpi_dir{vlSymsp->TOP.ulpi_dir}
    , ulpi_nxt{vlSymsp->TOP.ulpi_nxt}
    , ulpi_stp{vlSymsp->TOP.ulpi_stp}
    , ulpi_reset{vlSymsp->TOP.ulpi_reset}
